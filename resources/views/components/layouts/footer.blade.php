             ...
             <div class="row align-items-center">
                   ...
                   <div class="tp-footer-widget footer-col-1 mb-50">
                      <div class="tp-footer-widget-content">
                         <div class="tp-footer-logo">
                            <a href="index.html">
                               <img src="{{ asset('assets/img/logo/Gadchunk-logo.png') }}" width="50%" alt="logo">
                            </a>
                         </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                   <div class="tp-footer-widget footer-col-2 mb-50">
                      ...
                      <div class="tp-footer-widget-content">
                         <ul>
                            <li><a href="{{ route('order_list') }}">Track Orders</a></li>
                            <li><a href="{{ route('wishlist') }}">Wishlist</a></li>
                            <li><a href="{{ route('user.profile') }}">My Account</a></li>
                            <li><a href="{{ route('order_list') }}">Order History</a></li>
                         </ul>
                      </div>
                   </div>
                </div>
                   ...
                   <div class="tp-footer-widget footer-col-4 mb-50">
                      ...
                      <div class="tp-footer-widget-content">
                         <div class="tp-footer-talk mb-20">
                            ...
                            <h4><a href="tel:30000000000">+92 300000000000</a></h4>
                         </div>
                         <div class="tp-footer-contact">
                            <div class="tp-footer-contact-item d-flex align-items-start">
                               <div class="tp-footer-contact-icon">
                                  <span>
                                     <svg width="18" height="28" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               <div class="tp-footer-contact-content">
                                  <p><a href="mailto:shofy@support.com">GadChunk@support.com</a></p>
                               </div>
                            </div>
                            <div class="tp-footer-contact-item d-flex align-items-start">
                               <div class="tp-footer-contact-icon">
                                  <span>
                                     <svg width="17" height="28" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row align-items-center">
                   <div class="col-md-6">
                      <div class="tp-footer-copyright">
                         <p>© 2023 All Rights Reserved  | GADCHUNK <a href="{{ route('contact') }}">Company</a>.</p>
                      </div>
                   </div>
                   <div class="col-md-6">
