<div class="modal fade bs-example-modal-center  modalForAttrDel" id="modalForAttrShow-{{ $var->id }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <div class="container">
                    @if ($var->prod_attribute_value->isNotEmpty())
                    <table class="table table-hover rounded-lg ">
                        ...
                        <tbody>
                                ...
                                @foreach ($var->prod_attribute_value as $variation)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td col-span="2">{{ $variation->attribute_value }}</td>
