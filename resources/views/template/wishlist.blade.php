                            ...
                            <div id="wishlist">
                                ...
                                {{-- @dd($wishlist->product); --}}
                                    <tr id="remove{{ $wishlist->id }}">
                                        ...
                                        <td class="product-title">{{ $wishlist->product->name }}</td>
                                        <td class="price-col">{{ $wishlist->product->prod_inventory->retail_price }}
                                        </td>
                                        <td class="remove-col">
                                            <button type="button" class="btn btn-danger btn-remove wishremove"
                                            ...
                                            <button type="button" class="btn btn-primary add-cart"
                                                data-route="{{ route('add-cart', $wishlist->product->id) }}">Add to Cart</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </div>
