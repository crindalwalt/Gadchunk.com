                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4">
                                    <div class="myaccount-tab-menu nav" role="tablist">
                                        ...
                                        <a href="../frontEnd/login-register.html">Logout</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content" id="myaccountContent">
                                        ...
                                        <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                            <div class="myaccount-content">
                                                <h3>Dashboard</h3>
                                                <div class="welcome">
                                                    <p>Hello, <strong>Alex Tuntuni</strong> (If Not <strong>Tuntuni !</strong><a href="../frontEnd/login-register.html" class="logout"> Logout</a>)</p>
                                                </div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Pending</td>
                                                                <td>$3000</td>
                                                                <td><a href="cart.blade.php" class="check-btn sqr-btn ">View</a></td>
                                                            </tr>
                                                            <tr>
                                                                <td>2</td>
                                                                <td>July 22, 2018</td>
