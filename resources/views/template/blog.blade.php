              ...
              <div class="row">
                 <div class="col-xl-12">
                    <div class="tp-about-banner-thumb w-img">
                       <img src="assets/img/about/about-big-1.jpg" alt="">
                    </div>
                 </div>
              </div>
              <div class="row">
        ...
        <section class="tp-author-area pb-120">
           <div class="container">
              <div class="tp-author-inner p-relative z-index-1 tp-author-bg-overlay fix" data-bg-color="#821F40">
                 ...
                 <div class="tp-author-bg include-bg "  data-background="assets/img/author/author-bg.jpg"></div>
                       ...
                       <div class="tp-author-wrapper p-relative z-index-1">
                          <div class="tp-author-info-wrapper d-flex align-items-center mb-30">
                             <div class="tp-author-info-avater mr-10">
                                <img src="assets/img/users/user-4.jpg" alt="user">
                             </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                       <div class="tp-author-brand-wrapper d-flex flex-wrap align-items-center justify-content-lg-end">
                          <div class="tp-author-brand-item text-center">
                             <img src="assets/img/brand/author/logo_01.png" alt="">
                          </div>
                          <div class="tp-author-brand-item text-center">
                             <img src="assets/img/brand/author/logo_02.png" alt="">
                          </div>
                          <div class="tp-author-brand-item text-center">
                             <img src="assets/img/brand/author/logo_03.png" alt="">
                          </div>
                          <div class="tp-author-brand-item text-center">
                             <img src="assets/img/brand/author/logo_04.png" alt="">
                          </div>
                       </div>
                    </div>
                 </div>
