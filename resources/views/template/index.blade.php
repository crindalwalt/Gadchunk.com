                ...
                <div class="swiper-wrapper">
                    @if (!$collections->isEmpty())
                        @foreach ($collections as $collection)
                            <div
                                class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
                           ...
                           <img class="tp-slider-shape-3" src="{{ asset('assets/img/slider/shape/slider-shape-3.png') }}" alt="slider-shape">
                           <img class="tp-slider-shape-4" src="{{ asset('assets/img/slider/shape/slider-shape-4.png') }}" alt="slider-shape">
                        </div> --}}
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-xl-5 col-lg-6 col-md-6">
                                            <div class="tp-slider-content p-relative z-index-1">
                                                {{-- <span>Starting at <b>$199</b></span> --}}
                                                <h3 class="tp-slider-title">The best {{ $collection->name }} Collection
                                                    2023</h3>
                                                <p>Exclusive offer
                                                    <span> {{ $collection->discount_percentage }}
                                                        <svg width="94" height="20" viewBox="0 0 94 20"
                                                ...
                                                <div class="tp-slider-btn">
                                                    <a href="{{ route('shop') }}"
                                                        class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                        ...
                        <div
                            ...
                            <div class="tp-slider-shape">
                                <img class="tp-slider-shape-1"
                                    src="{{ asset('assets/img/slider/shape/slider-shape-1.png') }}" alt="slider-shape">
                                <img class="tp-slider-shape-2"
                                    src="{{ asset('assets/img/slider/shape/slider-shape-2.png') }}" alt="slider-shape">
                                <img class="tp-slider-shape-3"
                                    src="{{ asset('assets/img/slider/shape/slider-shape-3.png') }}" alt="slider-shape">
                                <img class="tp-slider-shape-4"
                                    src="{{ asset('assets/img/slider/shape/slider-shape-4.png') }}" alt="slider-shape">
                            </div>
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                        <div class="tp-slider-content p-relative z-index-1">
                                            <h3 class="tp-slider-title">Coming Soon!</h3>
                                            <p>Exclusive offer
                                                <span>Closes
                                                    <svg width="94" height="20" viewBox="0 0 94 20"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                        <div class="tp-slider-thumb text-end">
                                            <img src="{{ asset('assets/img/slider/coming-soon.jpg') }}"
                                                alt="slider-img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tp-product-category-thumb fix ">
                                        <a href="{{ route('shop') }}">
                                            <img height="50%" width="50%"
                                                src="{{ asset('storage/categories_icons/' . $top->icon) }}"
                                                alt="product-category">
                                        </a>
                                    </div>
                                    <div class="tp-product-category-content">
                                        <h3 class="tp-product-category-title">
                                            <a href="{{ route('shop') }}">{{ $top->name }}</a>
                                        </h3>
                                        <p>{{ count($top->product) }} Product</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="new-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="new-tab-pane" aria-selected="true">All
                                                    ...
                                                    @if ($product->prod_inventory)
                                                        @if ($product->prod_inventory->in_stock == 'yes')
                                                            <div class="modal fade tp-product-modal"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div
                                                                            class="tp-product-modal-content d-lg-flex align-items-start">
                                                                            <button type="button"
                                                                                class="tp-product-modal-close-btn"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#producQuickViewModal{{ $product->id }}"><i
                                                                                    class="fa-regular fa-xmark"></i></button>
                                                                            <div class="col-xl-7 col-lg-6">
                                                                                <div
                                                                                    class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                                                                                    <nav>
                                                                            ...
                                                                            <div class="tp-product-details-wrapper">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="tp-product-details-stock mb-10">
                                                                                        @if ($product->prod_inventory->in_stock == 'yes')
                                                                                            <span>In Stock</span>
                                                                                        @else
                                                                                    ...
                                                                                    @if (count($product->reviews) > 0)
                                                                                        @foreach ($product->reviews as $review)
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="tp-product-details-rating">
                                                                                    ...
                                                                                    @else
                                                                                        <div
                                                                                            class="tp-product-details-rating-wrapper d-flex align-items-center mb-10">
                                                                                            <div
                                                                                                class="tp-product-details-reviews">
                                                                                                <span>(No Rating
                                                                                                    Yet)</span>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                @if ($product->prod_inventory->discount_price)
                                                                                    @php
                                                                                        ...
                                                                                        $discount_value = ($trim_value / 100) * $product->prod_inventory->retail_price;
                                                                                        $value = $product->prod_inventory->retail_price - $discount_value;
                                                                                    @endphp
                                                                                    <!-- price -->
                                                                                    <div
                                                                                        class="tp-product-details-price-wrapper mb-20">
                                                                                        <span
                                                                                            class="tp-product-details-price old-price">Rs.
                                                                                            {{ $product->prod_inventory->retail_price }}</span>
                                                                                        <span
                                                                                            class="tp-product-details-price new-price">Rs.
                                                                                            {{ $value }}</span>
                                                                                    </div>
                                                                                @else
                                                                                    <span
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            @foreach ($product->sub_category->category->attributes as $attributes)
                                                                                                ...
                                                                                                @foreach ($attributes->prod_attribute_value as $value)
                                                                                                    <span
                                                                                                        class="badges">{{ $value->attribute_value }}</span>
                                                                                                @endforeach
                                                                                            @endforeach
                                                                                ...
                                                                                <!-- actions -->
                                                                                <div
                                                                                    class="tp-product-details-action-wrapper">
                                                                            ...
                                                                            <div class="tp-product-quantity mb-15 mr-15">
                                                                                ...
                                                                                <span class="tp-cart-plus">
                                                                                    <svg width="11" height="12" viewBox="0 0 11 12"
                                                                                        ...
                                                                                        @if (Auth::check())
                                                                                            @if ($product->prod_inventory->in_stock == 'yes')
                                                                                                <div
                                                                                                    class="tp-product-details-add-to-cart mb-15 w-100">
                                                                                                    <button
                                                                                                        class="tp-product-details-add-to-cart-btn w-100 add-cart"
                                                                                                        data-route="{{ route('add-cart', $product->id) }}">Add
                                                                                                        To
                                                                                                        Cart</button>
                                                                                                </div>
                                                                                            @else
                                                                                ...
                                                                                <div
                                                                                    class="tp-product-details-action-sm">
                                                                        ...
                                                                        Compare
                                                                                    ...
                                                                                    @if (Auth::check())
                                                                                        <button type="button"
                                                                                            class="tp-product-details-action-sm-btn add-wishlist"
                                                            ...
                                                            <div class="col-xl-3 col-lg-3 col-sm-6">
                                                                <div
                                                                    class="tp-product-item p-relative transition-3 mb-25">
                                                                    <div class="tp-product-thumb p-relative fix m-img">
                                                                        <a
                                                                            href="{{ route('product_detail', $product->id) }}">
                                                                            <img src="{{ asset('storage/inventory_images/' . $product->images[0]->product_image) }}"
                                                                        ...
                                                                        <div class="tp-product-action">
                                                                            <div
                                                                                class="tp-product-action-item d-flex flex-column">
                                                                                @if (Auth::check())
                                                                                    <button type="button"
                                                                                        class="tp-product-action-btn tp-product-add-cart-btn add-cart"
                                                                                        data-route="{{ route('add-cart', $product->id) }}">
                                                                                        <svg width="20"
                                                                                            height="20"
                                                                                            viewBox="0 0 20 20"
                                                                                            fill="none"
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#producQuickViewModal{{ $product->id }}">
                                                                                        <svg width="20"
                                                                                            height="17"
                                                                                            viewBox="0 0 20 17"
                                                                                            fill="none"
                                                                                        ...
                                                                                        <span
                                                                                            class="tp-product-tooltip">Quick
                                                                                            View</span>
                                                                                    </button>
                                                                                    <button type="button"
                                                                                        class="tp-product-action-btn tp-product-add-to-wishlist-btn add-wishlist"
                                                                                        data-route="{{ route('add.wishlist', $product->id) }}">
                                                                                        <svg width="20"
                                                                                            height="19"
                                                                                            viewBox="0 0 20 19"
                                                                    ...
                                                                    <div class="tp-product-content">
                                                                        ...
                                                                        <div
                                                                            class="tp-product-rating d-flex align-items-center">
                                                                        ...
                                                                        <div class="tp-product-price-wrapper">
                                                                            @if ($product->prod_inventory->discount_price)
                                                                                <span
                                                                                    class="tp-product-price old-price">Rs.
                                                                                    {{ $product->prod_inventory->retail_price }}</span>
                                                                                @php
                                                                                    $trim_value = trim($product->prod_inventory->discount_price, '%');
                                                                                    $discount_value = ($trim_value / 100) * $product->prod_inventory->retail_price;
                                                                                ...
                                                                                @endphp
                                                                                <span
                                                                                    class="tp-product-price new-price">Rs.{{ $value }}</span>
                                                                            @else
                                                                                <span
                                                                                    class="tp-product-price new-price">Rs.{{ $product->prod_inventory->retail_price }}</span>
                                                                            @endif
                                                    ...
                                                    @if ($product->prod_inventory)
                                                        @if ($product->prod_inventory->in_stock == 'yes')
                                                            @if ($product->prod_inventory->is_featured == 'yes')
                                                                <div class="modal fade tp-product-modal"
                                                                    id="producQuickViewModalfeatured{{ $product->id }}"
                                                                    tabindex="-1"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div
                                                                                ...
                                                                                <button type="button"
                                                                                    class="tp-product-modal-close-btn"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#producQuickViewModalfeatured{{ $product->id }}"><i
                                                                                        class="fa-regular fa-xmark"></i></button>
                                                                                <div class="col-xl-7 col-lg-6">
                                                                                    <div
                                                                                        class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                                                                ...
                                                                <div class="col-xl-3 col-lg-3 col-sm-6">
                                                                    <div
                                                                        class="tp-product-item p-relative transition-3 mb-25">
                                                                        <div
                                                                            class="tp-product-thumb p-relative fix m-img">
                                                                            <a
                                                                                href="{{ route('product_detail', $product->id) }}">
                                                                                <img src="{{ asset('storage/inventory_images/' . $product->images[0]->product_image) }}"
                                                                                    alt="product-electronic">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    @if (Auth::check())
                                                                                        ...
                                                                                        <button type="button"
                                                                                            class="tp-product-action-btn tp-product-quick-view-btn"
                                                                                            data-bs-toggle="modal"
                                                                                            data-bs-target="#producQuickViewModalfeatured{{ $product->id }}">
                                                                                            <svg width="20"
                                                                                                height="17"
                                                                                                viewBox="0 0 20 17"
                                                                                                fill="none"
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5">
                        <div class="tp-product-gadget-sidebar mb-40">
                            <div class="tp-product-gadget-categories p-relative fix mb-10">
                                ...
                                <h3 class="tp-product-gadget-categories-title">On Sale <br> Products</h3>
                                                ...
                                                @if ($product->is_active == 'yes')
                                                    @if ($product->prod_inventory)
                                                        @if ($product->prod_inventory->on_sale == 'yes')
                                                            <li><a
                                                                    href="{{ route('shop') }}">{{ $product->name }}</a>
                                                            </li>
                                                        @endif
                                                    @else
                                                        @continue
                                ...
                                <div class="tp-product-gadget-btn">
                                    <a href="{{ route('shop') }}" class="tp-link-btn">More Products
                                        <svg width="15" height="13" viewBox="0 0 15 13" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.9998 6.19656L1 6.19656" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M8.75674 0.975394L14 6.19613L8.75674 11.4177"
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="tp-product-gadget-wrapper">
                                        ...
                                        @if ($product->is_active == 'yes')
                                            @if ($product->prod_inventory)
                                                @if ($product->prod_inventory->in_stock == 'yes')
                                                    @if ($product->prod_inventory->on_sale == 'yes')
                                                        <div class="modal fade tp-product-modal"
                                                            id="producQuickViewModalsale{{ $product->id }}"
                                                            tabindex="-1" aria-labelledby="producQuickViewModal"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div
                                                                        ...
                                                                        <button type="button"
                                                                            class="tp-product-modal-close-btn"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#producQuickViewModalsale{{ $product->id }}"><i
                                                                                class="fa-regular fa-xmark"></i></button>
                                                                        <div class="col-xl-7 col-lg-6">
                                                                            <div
                                                                                class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            @if (Auth::check())
                                                                                ...
                                                                                <button type="button"
                                                                                    class="tp-product-action-btn tp-product-quick-view-btn"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#producQuickViewModalsale{{ $product->id }}">
                                                                                    <svg width="20"
                                                                                        height="17"
                                                                                        viewBox="0 0 20 17"
                                                                                        fill="none"
                            ...
                            @else
                                <div class="text-center">
                                    <h3 class="text-danger">Sale Offer Soon!</h3>
                                </div>
                            @endif
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="tp-product-banner-content p-relative z-index-1">
                                            ...
                                            <h3 class="tp-product-banner-title">Samsung Galaxy Tab S6, Wifi Tablet
                                            </h3>
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="tp-product-banner-thumb-wrapper p-relative">
                                            <div class="tp-product-banner-thumb-shape">
                                                ...
                                                <img class="tp-offer-shape"
                                                    src="assets/img/banner/banner-slider-offer.png" alt="">
                                            </div>
                            ...
                            <div class="tp-product-banner-inner theme-bg p-relative z-index-1 fix swiper-slide">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="tp-product-banner-content p-relative z-index-1">
                                            <span class="tp-product-banner-subtitle">Tablet Collection 2023</span>
                                            <h3 class="tp-product-banner-title">Microsoft Surface Pro 8, Wifi Included
                                            </h3>
                                            <div class="tp-product-banner-price mb-40">
