								...
								<div id="best_deals_tab" class="tab-pane active">
									...
									<li>
										<div class="supermarket_product_item">
											...
											<div class="item_content">
												<span class="item_type text-uppercase">{{$item->products->category->name}}</span>
												<h3 class="item_title">
													<a href="#!">
														{{$item->products->name}}
													</a>
												...
												<div class="item_price">
													...
													<div class="d-flex justify-content-end">
														<a class="tooltips bg_supermarket_red p-2 mr-2 text-white rounded add-cart" data-route="{{route('add-cart'),$item->id}}" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-cart"></i></a>
														<a class="tooltips  bg_supermarket_red p-2 text-white rounded" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a>		
													</div>
												</div>
