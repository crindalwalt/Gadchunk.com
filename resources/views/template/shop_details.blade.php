                            ...
                            <div class="tp-product-details-wrapper">
                                ...
                                <div class="tp-product-details-price-wrapper mb-20">
                                    @if ($product->prod_inventory->discount_price)
                                        ...
                                        @endphp
                                        <span class="tp-product-price new-price">Rs.{{ $value }}</span>
                                    @else
                                        <span
                                    ...
                                    {{-- <button type="button" class="tp-product-details-action-sm-btn">
                                        <svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M3.25177 0.985168L1 3.16433L3.25177 5.34354"
                                                stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                ...
                                <div class="tp-product-details-social">
                                    <span>Share: </span>
                                    <a href="product-details.html#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="product-details.html#"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="product-details.html#"><i class="fa-brands fa-linkedin-in"></i></a>
                                    <a href="product-details.html#"><i class="fa-brands fa-vimeo-v"></i></a>
                                </div> --}}
                                                ...
                                                <div class="col-xl-10">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="tp-product-details-desc-content">
                                                                    ...
                                                                    <p>S Pen is a bundle of writing instruments in one.
                                                                        Its natural grip, <br> low latency and
                                                                        impressive pressure sensitivity will make it
                                                    ...
                                                    <div class="tp-product-details-desc-item  pb-75">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <div class="tp-product-details-desc-thumb">
                                                                    <img src="assets/img/product/details/desc/product-details-desc-2.jpg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-5 order-first order-lg-last">
                                                                <div
                                                                    ...
                                                                    <h3 class="tp-product-details-desc-title">Carry
                                                                        with <br> Confidence and style</h3>
                                                                    <p>Wrap your tablet in a sleek case that's as
                                                                        stylish as it is convenient. Galaxy Tab S6 Lite
                                                                        Book Cover folds around and clings magnetically,
                                                                        so you can easily gear up as you're headed out
                                                                        the door. There's even a compartment for S pen,
                                                                        so you can be sure it doesn't get left behind.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div
                                                                    ...
                                                                    <img src="assets/img/product/details/desc/product-details-desc-3.jpg"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xl-10">
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Batteries</td>
                                                                <td>1 Lithium Polymer batteries required. (included)
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p>({{ count($product->reviews) }} Review)</p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="assets/img/product/related/product-related-1.jpg"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="assets/img/product/related/product-related-2.jpg"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="assets/img/product/related/product-related-3.jpg"
                                                    alt="">
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                            <a href="product-details.html">
                                                <img src="assets/img/product/related/product-related-4.jpg"
                                                    alt="">
                                            </a>
