        ...
        <div id="rev_slider" class="rev_slider" data-version="5.0">
            <ul>
                ...
                <li data-transition="fade">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('assets/images/home2-banner1.jpg') }}" alt=""
                        data-bgposition="center center" data-bgfit="cover">
                    <div class="tp-caption tp-resizeme" data-x="right" data-hoffset="" data-y="0" data-voffset="10"
                        data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']"
                        data-transform_idle="o:1;" data-transform_in="x:right;s:2000;e:Power4.easeInOut;"
                        data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="3000"
                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                        style="z-index: 7; white-space: nowrap;">
                        <img src="{{ asset('assets/images/home2-banner1layer1.png') }}" alt="">
                    </div>
                    <!-- LAYER NR. 1 -->
                    <h3 class="tp-caption tp-resizeme uppercase" data-x="left" data-y="185" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                        data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="800">new
                        arrivals
                    </h3>
                    <h1 class="tp-caption tp-resizeme uppercase" data-x="left" data-y="228" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                        data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1000">
                        <strong>new style
                        </strong> for lamp
                    </h1>
                    <div class="tp-caption tp-resizeme" data-x="left" data-y="415" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                    ...
                    <div class="tp-caption tp-resizeme" data-x="left" data-y="510" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                ...
                <li data-transition="fade">
                    <img src="{{ asset('assets/images/banner2.png') }}" alt="" data-bgposition="center center"
                        data-bgfit="cover">
                    <div class="tp-caption tp-resizeme" data-x="500" data-hoffset="" data-y="0" data-voffset="10"
                        data-width="['auto','auto','auto','auto']" data-height="['auto','auto','auto','auto']"
                        data-transform_idle="o:1;" data-transform_in="x:right;s:2000;e:Power4.easeInOut;"
                        data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-start="3000"
                        data-splitin="none" data-splitout="none" data-responsive_offset="on"
                        style="z-index: 7; white-space: nowrap;">
                        <img src="{{ asset('assets/images/baner1-layer.png') }}" alt="">
                    </div>
                    <h3 class="tp-caption tp-resizeme uppercase" data-x="left" data-y="185" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                        data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="800">new
                    ...
                    <h1 class="tp-caption  tp-resizeme uppercase" data-x="left" data-y="228" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                        data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1100">
                        <strong>new style
                        </strong> for lamp
                    </h1>
                    <div class="tp-caption  tp-resizeme" data-x="left" data-y="415" data-width="full"
                        data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;"
                        data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1400">
                        <p>Claritas est etiam processus dynamicus, qui sequitur mutationem
                            <br>consuetudium lectorum.
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <a class="grid_box clearfix" href="grid_list.html">
                        <div class="image_left">
                            <img src="{{ asset('assets/images/product-box1.png') }}" alt="Product">
                        </div>
                        <div class="grid_body">
                ...
                <div class="col-sm-4">
                    <a class="grid_box clearfix" href="grid_list.html">
                        <div class="image_left">
                            <img src="{{ asset('assets/images/product-box2.png') }}" alt="Product">
                        </div>
                        <div class="grid_body">
                ...
                <div class="col-sm-4">
                    <a class="grid_box clearfix" href="grid_list.html">
                        <div class="image_left">
                            <img src="{{ asset('assets/images/product-box3.png') }}" alt="Product">
                        </div>
                        <div class="grid_body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="heading_space uppercase">Shop Now
                    </h2>
                        ...
                        <div class="item">
                            <div class="product_wrap">
                                ...
                                <div class="product_desc">
                                    <p>{{ $product->products->name }} <span>({{ $product->products->category->name }})</span>
                                    </p>
                                    <span class="price">
                                        <i class="fa fa-gbp">
                ...
                <div class="design clearfix">
                    <div class="col-md-5 col-md-offset-1">
                        <div class="design_img">
                            ...
                            <img src="{{ asset('assets/images/design-prouct.jpg') }}" alt="desing Product">
                        </div>
                    </div>
                    <div class="col-md-5 col-md-offset-1">
                        <div class="descrp">
                            ...
                            <ul class="review">
                                <li>
                                    <img src="{{ asset('assets/images/star.png') }}" alt="rating">
                                </li>
                                <li>
                                    <a href="#.">10 review(s)
                                    </a>
                            ...
                            <div class="countdown countdown-container margintop15" data-start="1362139200"
                                data-end="1388461320" data-now="1387461319" data-border-color="#79b6c8">
                                <div class="clock row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product_wrap bottom_half">
                        <div class="image">
                            <a class="fancybox" href="{{ asset('assets/images/product2.jpg') }}">
                                <img src="{{ asset('assets/images/product2.jpg') }}" alt="Product"
                                    class="img-responsive">
                            </a>
                        </div>
                        <div class="product_desc">
                    ...
                    <div class="product_wrap bottom_half">
                        <div class="image">
                            ...
                            <a class="fancybox" href="{{ asset('assets/images/product3.jpg') }}">
                                <img src="{{ asset('assets/images/product3.jpg') }}" alt="Product"
                                    class="img-responsive">
                            </a>
                        </div>
                        <div class="product_desc">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product_wrap bottom_half">
                        <div class="image">
                            <a class="fancybox" href="{{ asset('assets/images/product4.jpg') }}">
                                <img src="{{ asset('assets/images/product4.jpg') }}" alt="Product"
                                    class="img-responsive">
                            </a>
                        </div>
                        <div class="product_desc">
            ...
            <div class="row">
                    ...
                    <div class="media blog_box">
                        <div class="media-left">
                            <a href="blog_post.html">
                                <img class="media-object" src="{{ asset('assets/images/blog1.jpg') }}"
                                    alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                            ...
                            <p class="bottom30">Mirum est notare quam littera gothica, quam nunc putamus parum claram,
                ...
                <div class="col-md-6">
                    <div class="media blog_box">
                        <div class="media-left">
                            <a href="blog_post.html">
                                <img class="media-object" src="{{ asset('assets/images/blog2.jpg') }}"
                                    alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="col-md-12">
                    <div id="brand-slider" class="owl-carousel">
                        <div class="item text-center">
                            <img src="{{ asset('assets/images/logo1.jpg') }}" alt="Brand Logo">
                        </div>
                        <div class="item text-center">
                            <img src="{{ asset('assets/images/logo1.jpg') }}" alt="Brand Logo">
                        </div>
                    ...
                    <div id="tstinomial-slider" class="owl-carousel">
                        <div class="item text-center">
                            <div class="testinomial_pic heading_space">
                                <img src="{{ asset('assets/images/testinomial1.png') }}" alt="testinomial">
