        ...
        @if ($item->is_active == 'yes')
            @if ($item->prod_inventory)
                @if ($item->prod_inventory->in_stock == 'yes')
                    <div class="col-xl-12">
                        <div class="tp-product-list-item d-md-flex my-2">
            ...
            <span class="tp-product-tooltip tp-product-tooltip-right">Quick
                View</span>
                                        ...
                                        @if (Auth::check())
                                            <button type="button"
                                                class="tp-product-action-btn-2 tp-product-add-cart-btn add-cart"
                                                data-route="{{ route('add-cart', $item->id) }}">
                                            ...
                                            <button type="button"
                                                class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn add-wishlist"
                                ...
                                <div class="tp-product-content-2 pt-15">
                                    ...
                                    <div class="tp-product-price-wrapper-2">
                                        @if ($item->prod_inventory->discount_price)
                                            <span class="tp-product-price-2 old-price">Rs.
                                            ...
                                            @endphp
                                            <span class="tp-product-price-2 new-price">Rs.{{ $value }}</span>
                                        @else
                                            <span
                                    ...
                                    @if (Auth::check())
                                        <div class="tp-product-list-add-to-cart">
                                            <button class="tp-product-list-add-to-cart-btn add-cart"
                                    ...
                                    @else
                                        <div class="tp-product-list-add-to-cart">
                                            <a href="{{ route('login') }}">
                                                <button class="tp-product-list-add-to-cart-btn ">Add
                                                    To Cart</button>
                                            </a>
                                        </div>
                                    @endif
