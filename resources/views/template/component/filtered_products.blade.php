            ...
            <div class="tp-product-modal-content d-lg-flex align-items-start">
                ...
                <div class="tp-product-details-wrapper">
                        ...
                        <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                            ...
                            @if ($item->prod_inventory->in_stock == 'yes')
                                <div class="tp-product-details-add-to-cart mb-15 w-100">
                                    <button class="tp-product-details-add-to-cart-btn w-100 add-cart"   data-route="{{ route('add-cart', $item->id ) }}">Add To
                                        Cart</button>
                                </div>
                            @else
                    ...
                    <div class="tp-product-details-action-sm">
                        ...
                        <button type="button" class="tp-product-details-action-sm-btn add-wishlist" data-route="{{ route('add.wishlist', $item->id) }}">
    ...
    <div class="tp-product-item-2 mb-40">
          ...
          @endif
            ...
            <div class="tp-product-action-2 tp-product-action-blackStyle">
                <div class="tp-product-action-item-2 d-flex flex-column">
                    <button type="button"
                        class="tp-product-action-btn-2 tp-product-add-cart-btn add-cart" data-route="{{ route('add-cart', $item->id) }}">
                    ...
                    <button type="button"
                        class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn add-wishlist" data-route="{{ route('add.wishlist', $item->id) }}">
        ...
        <div class="tp-product-content-2 pt-15">
            ...
            @else
                <div class="tp-product-details-rating-wrapper d-flex align-items-center mb-10">
                    <div class="tp-product-details-reviews">
                        <span class="text-dark">(No Rating Yet)</span>
                    </div>
                </div>
            @endif
            </div>
