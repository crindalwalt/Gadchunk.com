                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('sub_category.store') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <p class="card-title-desc">You can add product sub-categories here</p>
                                            </div>
                                            <div>
                                                <div class="float-end d-none d-sm-block">
                                                    <a href="{{ route('category.index') }}" class="btn btn-primary shadow-lg">
                                        ...
                                        <div class="row mb-3">
                                            <div class="#">
                                                <input class="btn btn-lg px-4 py-2 btn-primary" type="submit"
                                                    value="Add Sub-Category" id="example-email-input">
                                            </div>
                                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($sub_categories as $category)
                                                        <tr>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ route('sub_category.edit', $category->id) }}"
                                                                ...
                                                                <form action="{{ route('sub_category.delete') }}"
